...
export default function Leaderboard() {
  ...
  return (
    <div className="flex flex-col h-full bg-blue-950"> {/* Changed to solid blue background */}
      <div className="border-b border-slate-700"> {/* Removed bg-slate-900/80 backdrop-blur-sm */}
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 flex-grow overflow-auto w-full">
